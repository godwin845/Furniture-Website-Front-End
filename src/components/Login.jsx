...
const Login = ({ onSuccess }) => {
  ...
  return (
    <div className="selection:bg-[#FB7B9B] selection:text-black flex justify-center items-center min-h-screen bg-opacity-50 bg-[#B33C4A] text-white font-sans">
      <div className="animate__animated animate__fadeInRight rounded-4xl p-8 w-[320px] max-w-[400px]"
        style={{ backgroundImage: `url(${LoginImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
      >

        <h1 className="text-center text-[25px] text-black font-bold">Login</h1>
        ...
        <div className="flex justify-center mt-5">
          <div className="text-xs font-normal">Don’t have an account?</div>
            <Link to='/register' className="text-xs font-extrabold ml-2 cursor-pointer">Signup</Link>
          </div>
      </div>
    </div>
  );
